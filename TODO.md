...
**Шаги:**
0. Все php команды выполнять только изнутри докер!!!
...
Реализован page builder для статических страниц с 10 типами секций (hero, text, categories_grid, services_list, portfolio, cta_form, contacts, gallery, advantages, global_block).
Добавлена возможность переупорядочивания секций (кнопки вверх/вниз).
Созданы глобальные блоки с переиспользованием; изменения блока отражаются во всех вставках.
Настроен предпросмотр собранных страниц и глобальных блоков.
...
Добавлены проверки публичных маршрутов и поиска, предпросмотра страниц/блоков, отправки форм с дедупликацией и ограничения доступа в админку (см. новые тесты в `tests/Feature`).
