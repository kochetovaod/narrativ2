...
- Внедрить реальные проверки reCAPTCHA/hCaptcha (серверные вызовы API, конфиги в env, фолыбэк при ошибках) и покрыть это фиче-тестом отправки формы. 【F:app/Http/Controllers/FormController.php†L229-L272】
