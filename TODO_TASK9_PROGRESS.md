...
- [ ] 5.3. Добавить пункт меню в PlatformProvider
- [ ] 5.4. Настроить права доступа
...
1. Добавить пункт меню "Импорт/Экспорт" в PlatformProvider
2. Настроить права доступа (permissions) для импорт/экспорт
3. Протестировать систему в Docker
4. Запустить миграцию и сидеры
